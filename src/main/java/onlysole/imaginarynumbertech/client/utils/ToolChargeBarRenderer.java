...
public final class ToolChargeBarRenderer {
    ...
    public static void renderBarsItem(INTMetaItem<?> metaItem, ItemStack stack, int xPosition, int yPosition) {
        boolean renderedDurability = false;
        INTMetaItem<?>.MetaValueItem valueItem = metaItem.getItem(String.valueOf(stack));
