package onlysole.imaginarynumbertech.api.items;
...
public class IntCircuitIngredientBiology extends GTRecipeItemInput {
    ...
    public static ItemStack getIntegratedCircuit(int configuration) {
        ItemStack stack = INTMetaItems.BIOLOGY_INTEGRATED_CIRCUIT.getStackForm();
        setCircuitConfiguration(stack, configuration);
        return stack;
    }

    public static void setCircuitConfiguration(ItemStack itemStack, int configuration) {
        if (!INTMetaItems.BIOLOGY_INTEGRATED_CIRCUIT.isItemEqual(itemStack))
    ...
    public static boolean isIntegratedCircuit(ItemStack itemStack) {
        boolean isCircuit = INTMetaItems.BIOLOGY_INTEGRATED_CIRCUIT.isItemEqual(itemStack);
    ...
    public boolean acceptsStack( ItemStack itemStack) {
        return itemStack != null && INTMetaItems.BIOLOGY_INTEGRATED_CIRCUIT.isItemEqual(itemStack) &&
