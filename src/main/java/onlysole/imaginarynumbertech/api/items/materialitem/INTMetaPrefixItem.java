package onlysole.imaginarynumbertech.api.items.materialitem;
...
//2024-12-29
public class INTMetaPrefixItem extends INTStandardMetaItem {
    ...
    public INTMetaPrefixItem(@NotNull MaterialRegistry registry, @NotNull OrePrefix orePrefix) {
        super();
        this.registry = registry;
        this.prefix = orePrefix;
        this.setCreativeTab(CommonProxy.IMAGINARY_TAB);
    }
     ...
     * Requires the ItemStack's item to be a INTMetaPrefixItem.
     *
     * @return the material
     */
    @Nullable
    ...
    /**
     * Attempt to get a material from an ItemStack, whose item may not be a INTMetaPrefixItem.
     *
     * @return the material
     */
//    @Nullable
//    public static Material tryGetMaterial(@NotNull ItemStack itemStack) {
//        if (itemStack.getItem() instanceof INTMetaPrefixItem metaPrefixItem) {
