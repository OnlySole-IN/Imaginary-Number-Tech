package onlysole.imaginarytech.client.utils;

import net.minecraft.client.Minecraft;
import net.minecraft.client.renderer.OpenGlHelper;
import onlysole.imaginarytech.api.utils.ITLog;
import onlysole.imaginarytech.client.shader.ShaderCallback;
...
public final class ShaderHelper {
    ...
    private static final String PREFIX = "/assets/imaginarytech/shader/";
    ...
    private static int createProgram(String vert, String frag) {
        ...
        if (ARBShaderObjects.glGetObjectParameteriARB(program, ARBShaderObjects.GL_OBJECT_LINK_STATUS_ARB) == GL11.GL_FALSE) {
            ITLog.logger.log(Level.ERROR, getLogInfo(program));
            return 0;
        }
