package onlysole.imaginarytech.common.items;
...
import onlysole.imaginarytech.common.items.behaviors.renderer.CosmicRenderItemBehavior;
import onlysole.imaginarytech.common.items.behaviors.renderer.HaloRenderItemBehavior;

import static onlysole.imaginarytech.common.items.ITMetaItems.*;

public class ITMetaItem1 extends StandardMetaItem {

    public ITMetaItem1() {
        this.setRegistryName("meta_item_it");
    ...
    public void registerSubItems(){
        ...
        SUPRACAUSAL_PROCESSOR = this.addItem(16, "circuit.supracausal_processor")
                .setUnificationData(OrePrefix.circuit, MarkerMaterials.Tier.UIV)
                .addComponents(new HaloRenderItemBehavior(10, 0xFF000000, () -> ITTextures.HALO, true));
...
//                .setMaxStackSize(1).addComponents(new MillBallBehavior());
        NULL = this.addItem(48, "null")
                .addComponents(new CosmicRenderItemBehavior(() -> ITTextures.MASK_INGOT, 1));
...
//                .addComponents(new IntBcircuitBehavior());
        ...
        ETERNAL_SINGULARITY = this.addItem(240, "singularity.eternal_singularity")
                .addComponents(new CosmicRenderItemBehavior(() -> ITTextures.ETERNAL_SINGULARITY, 1));
        GASTRONOMIC_SINGULARITY = this.addItem(241, "singularity.gastronomic_singularity")
                .addComponents(new CosmicRenderItemBehavior(() -> ITTextures.COMBINED_SINGULARITY, 1));
